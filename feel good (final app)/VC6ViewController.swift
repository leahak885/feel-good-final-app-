...
class VC6ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let attributedString = NSMutableAttributedString(string: "click here for more info")
                attributedString.addAttribute(.link, value: "https://www.nationaleatingdisorders.org/learn/by-eating-disorder/anorexia", range: NSRange(location: 6, length: 4))
                    textView6.attributedText = attributedString
                       }
                       
        func textView(_ textView6: UITextView, shouldInteractWith URL: URL, in
